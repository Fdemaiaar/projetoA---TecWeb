...
class DatabaseTestCase(unittest.TestCase):
    ...
    def test_add_rows(self):
        ...
        assert data == result, f'Os dados não foram inseridos corretamente. Era esperado: {data}\nporém foi obtido {result}'
    ...
    def test_select_rows(self):
        ...
        assert all(n.id != None for n in notes), f'As notas estão sem a informação do id.'
